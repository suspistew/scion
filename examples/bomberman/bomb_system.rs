...
pub fn explosion_system(data: &mut GameData) {
        ...
        if !animations.any_animation_running() {
            {
                ...
                if *left == 4 {
                    ...
                    to_modify.push((Position::new(bomb.pos_x - 1, bomb.pos_y, 2), 0));
                }
            }
            {
            ...
            }
            {
                ...
                if *top == 4 {
                    ...
                    to_modify.push((Position::new(bomb.pos_x, bomb.pos_y - 1, 2), 0));
                }
            }
            {
